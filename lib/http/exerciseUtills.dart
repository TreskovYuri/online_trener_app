...
import 'package:trener_app/models/exercise/exercise.dart';
import 'package:trener_app/models/exercise/exercise_group.dart';
...
Future GetGroups() async {
  ...
  try {
    ...
    if (data['status'] < 300) {
      data['body'].forEach((e) {
        ExerciseGroup group = ExerciseGroup(
            id: e['id'] ?? 0,
            name: e['name'] ?? '',
